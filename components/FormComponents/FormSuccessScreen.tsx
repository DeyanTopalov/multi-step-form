...
const FormSuccessScreen = ({ handleClose }: FormSuccessScreenProps) => {
  return (
    <section className="mx-4 grid -translate-y-[4.5rem] place-items-center rounded-lg bg-white px-6 py-8 text-center drop-shadow-lg md:mx-0 md:max-w-[28.125rem] md:translate-y-0 md:bg-transparent md:px-0 md:py-0 md:drop-shadow-none">
